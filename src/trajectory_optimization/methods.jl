...
function ProblemMethods(trajopt::TrajectoryOptimizationProblem) 
    ProblemMethods(
        ...
        zeros(length(vcat(trajopt.sparsity.dynamics_jacobian_variables...)) + length(vcat(trajopt.sparsity.equality_jacobian_variables...))), 
        zeros(length(vcat(trajopt.sparsity.dynamics_jacobian_parameters...)) + length(vcat(trajopt.sparsity.equality_jacobian_parameters...))),
        ...
        zeros(length(vcat(trajopt.sparsity.dynamics_jacobian_variables_variables...)) + length(vcat(trajopt.sparsity.equality_jacobian_variables_variables...))), 
        zeros(length(vcat(trajopt.sparsity.dynamics_jacobian_variables_parameters...)) + length(vcat(trajopt.sparsity.equality_jacobian_variables_parameters...))),
