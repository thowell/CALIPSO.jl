struct ProblemMethods{T,O,OX,OP,OXX,OXP,E,EX,EP,ED,EDX,EDXX,EDXP,C,CX,CP,CD,CDX,CDXX,CDXP}
    ...
    equality_jacobian_variables_cache::Vector{T}                    # gx 
    equality_jacobian_parameters_cache::Vector{T}                   # gθ
    equality_jacobian_variables_sparsity::Vector{Tuple{Int,Int}}                    # gx 
    equality_jacobian_parameters_sparsity::Vector{Tuple{Int,Int}}                   # gθ
    ...
    equality_dual_jacobian_variables_variables_cache::Vector{T}   # (g'y)xx
    equality_dual_jacobian_variables_parameters_cache::Vector{T}  # (g'y)xθ
    equality_dual_jacobian_variables_variables_sparsity::Vector{Tuple{Int,Int}}   # (g'y)xx
    equality_dual_jacobian_variables_parameters_sparsity::Vector{Tuple{Int,Int}}  # (g'y)xθ
    
    cone_constraint::C                                 # h
    cone_jacobian_variables::CX                        # hx 
    cone_jacobian_parameters::CP                       # hθ
    cone_jacobian_variables_cache::Vector{T}                        # hx 
    cone_jacobian_parameters_cache::Vector{T}                       # hθ
    cone_jacobian_variables_sparsity::Vector{Tuple{Int,Int}}                        # hx 
    cone_jacobian_parameters_sparsity::Vector{Tuple{Int,Int}}                       # hθ
    cone_dual::CD                                      # h'z
